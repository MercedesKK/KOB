                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button @click="add_bot" type="button" class="btn btn-secondary">创建</button>
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea v-model="bot.description" type="text"
                                                                    class="form-control" rows="3" id="add-bot-description"
...
export default {
    ...
    setup() {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app4931.acapp.acwing.com.cn/api/user/bot/add/",
                type: "POST",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            bot.error_message = "";
            $.ajax({
                url: "https://app4931.acapp.acwing.com.cn/api/user/bot/update/",
                type: "POST",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app4931.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "POST",
                data: {
                    bot_id: bot.id,
                },
