        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <router-link :class="route_name == 'pk_index' ? 'nav-link active' : 'nav-link'"
              :to="{ name: 'forum_index' }">论坛</router-link>
          </li>
            ...
            <ul class="dropdown-menu">
              <li class="nav-item">
                <router-link :class="route_name == 'pk_index' ? 'nav-link active' : 'nav-link'" :to="{ name: 'pk_index' }"
                  style="color: black; text-align: center;">游戏对战</router-link>
              </li>
              <li class="nav-item">
                <router-link :class="route_name == 'record_index' ? 'nav-link active' : 'nav-link'"
                  :to="{ name: 'record_index' }" style="color: black; text-align: center;">对局列表</router-link>
              </li>
              <li class="nav-item">
                <router-link :class="route_name == 'ranklist_index' ? 'nav-link active' : 'nav-link'"
                  :to="{ name: 'ranklist_index' }" style="color: black; text-align: center;">排行榜</router-link>
              </li>
            </ul>
          </li>
        </ul>
